...
const HeartIcon: FC<IconProps> = ({ className, color, width, height, ...props }) => {
  const classHeartIcon = classNames(styles.heartIcon, className, {
    [styles[`heartIcon_${color}`]]: color,
  });
  return (
    <svg
