...
const ProfileIcon: FC<IconProps> = ({ className, color, width, height, ...props }) => {
  const classProfileIcon = classNames(styles.profileIcon, className, {
    [styles[`profileIcon_${color}`]]: color,
  });
  return (
    <svg
